...
public class CodeTreeImpl<TreeCodeType extends TreeCode> extends TreeImpl<TreeCodeType> implements CodeTree<TreeCodeType> {
	...
	public List<TreeCodeType> getSubCodes(Long rootCode, boolean includeRoot, boolean isAll, Long excludedId){
		List<TreeCodeType> list=new ArrayList<>();
	...
	public void getSubCodes(TreeNode<TreeCodeType> root, boolean includeRoot, boolean isAll, Long excludedId, List<TreeCodeType> list){
		if(includeRoot){
			TreeCodeType rootCode= root.getData();
