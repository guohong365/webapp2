...
public class BasicCodeTree<TreeCodeType extends BasicTreeCode> extends TreeImpl<TreeCodeType> implements CodeTree<String,TreeCodeType> {
	...
	@Override
	public List<TreeCodeType> getSubItemList(String rootCode, int depth, boolean includeRoot) {
		List<TreeCodeType> list=new ArrayList<>();
	...
	@Override
	public List<TreeCodeType> getSubItemList(String rootCode, int depth, IFilter<TreeCodeType> filter) {		
		List<TreeCodeType> list=new ArrayList<>();
		TreeNode<TreeCodeType> from=findCode(getRoot(), rootCode);
		if(from!=null){
	...
	@Override
	public List<TreeCodeType> getSubItemList(String id, boolean includeRoot){
		List<TreeCodeType> list=new ArrayList<>();
	...
	@Override
	public List<TreeCodeType> getSubItemList(String id, IFilter<TreeCodeType> filter) {
		List<TreeCodeType> list=new ArrayList<>();
		TreeNode<TreeCodeType> rootItem;
	...
	public TreeNode<TreeCodeType> findCode(TreeNode<TreeCodeType> from, String code){
	...
	@Override
	public TreeNode<TreeCodeType> findCode(String code) {
	...
	public static BasicCode getBasicCodeFromTreeCode(BasicTreeCode treeCode){
		BasicCode basicCode=new BasicCode(treeCode.getCode(),treeCode.getValue(), treeCode.getValid());
		return basicCode;
	}
	...
	public void getSubCodes(TreeNode<TreeCodeType> root, boolean includeRoot, boolean isAll, String excludedId, List<BasicCode> list){
		if(includeRoot){
			BasicTreeCode rootCode= root.getData();
			...
			if(rootCode.getValid() || isAll){
				list.add(getBasicCodeFromTreeCode(rootCode));
			}
		}
